        ...
        <Grid container className={'shopping-List'}>
          ...
          <Grid item xs={10}>
            <Grid container>
              ...
              <Grid item xs={3}>
                <span onClick={this.priceLowToHigh}>Price: Low to High</span>
              </Grid>
              <Grid item xs={3}>
                <span onClick={this.priceHighToLow}>Price: High to Low</span>
              </Grid>
              <Grid item xs={3}>
                <span onClick={this.dicountHighToLow}>Discount</span>
              </Grid>
            </Grid>
            {shoppingList.length > 0 ? shoppingListToDisplay : ''}
          </Grid>
